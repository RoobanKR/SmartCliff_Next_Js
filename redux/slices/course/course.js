...
export const fetchCourses = createAsyncThunk(
  ...
  async () => {
    const response = await axios.get(`https://smartcliff-server-1.onrender.com/getAll/course`);
...
export const fetchCourseById = createAsyncThunk(
  ...
  async (id) => {
    try {
      const response = await axios.get(`https://smartcliff-server-1.onrender.com/getById/course/${id}`);

...
export default function TearmsAndContition() {
  return (
    <>
          ...
          <div className="row justify-center">
            <div className="col-xl-12 col-lg-9 col-md-11">
              <ol className="list-decimal ml-5">
                ...
                <li className="mt-6" style={{fontFamily:"Montserrat, sans-serif"}}>
                  <span className="font-medium" style={{fontSize:"25px",color:"rgb(139, 102, 168)",fontWeight:"600"}}>2.</span>
                  <span style={{fontWeight:"100",color:"rgb(33, 37, 41)",fontSize:"17px",lineHeight:"1.5",fontFamily:"Montserrat, sans-serif"}}>Your Personal Information may comprise the following:</span>
                ...
                <li className="mt-6" style={{fontFamily:"Montserrat, sans-serif"}}>
                  <span className="font-medium" style={{fontSize:"25px",color:"rgb(139, 102, 168)",fontWeight:"600"}}>3.</span>
                  <span style={{fontWeight:"100",color:"rgb(33, 37, 41)",fontSize:"17px",lineHeight:"1.5",fontFamily:"Montserrat, sans-serif"}}> The following Privacy Policy sets forth our understanding with you on the collection, use and protection of your Personal Information. Please read the entire Privacy Policy.
                  </span>
                </li>
                
                <li className="mt-6" style={{fontFamily:"Montserrat, sans-serif"}}>
                  <span className="font-medium" style={{fontSize:"25px",color:"rgb(139, 102, 168)",fontWeight:"600"}}>4.</span>
                  <span style={{fontWeight:"100",color:"rgb(33, 37, 41)",fontSize:"17px",lineHeight:"1.5",fontFamily:"Montserrat, sans-serif"}}> YOUR USE OF THE WEBSITE CONSTITUTES YOUR CONSENT TO THE ALL THE TERMS AND CONDITIONS CONTAINED IN THIS PRIVACY POLICY (AS AMENDED FROM TIME TO TIME) AND YOU SHALL BE BOUND BY THE SAME.

</span>
                </li>
                
                <li className="mt-6 font-medium">
                  <span className="font-medium" style={{fontSize:"25px",color:"rgb(139, 102, 168)",fontWeight:"600"}}>5.</span> 
                  <span style={{fontWeight:"600",fontSize:"25px",color:"#8B66A4",marginBottom:"15px"}}> COLLECTION OF INFORMATION</span>
                </li>
              </ol>

              <ol className="list-alpha ml-8 mt-6">
                <li className="mt-6" style={{fontFamily:"Montserrat, sans-serif"}}>
                  <span className="font-medium" style={{fontSize:"20px",color:"rgb(139, 102, 168)",fontWeight:"600"}}>1.</span>
                  <span style={{fontWeight:"bold",fontSize:"17px",color:"#8B66A4",marginBottom:"15px"}}>SITE BROWSING: </span>
                  <span style={{fontWeight:"100",color:"rgb(33, 37, 41)",fontSize:"17px",lineHeight:"1.5",fontFamily:"Montserrat, sans-serif"}}> You browse the Site anonymously. We do not require you to identify yourself or reveal any Personal Information while browsing through the Site. However, you may not be able to interact with us without supplying us with Personal Information. If you desire to contact us to associate/ work with us / donate through the Site, you would be required to provide your Personal Information.
                  </span>
                </li>
                
                <li className="mt-6" style={{fontFamily:"Montserrat, sans-serif"}}>
                  <span className="font-medium" style={{fontSize:"20px",color:"rgb(139, 102, 168)",fontWeight:"600"}}>2.</span>
                  <span style={{fontWeight:"100",color:"rgb(33, 37, 41)",fontSize:"17px",lineHeight:"1.5",fontFamily:"Montserrat, sans-serif"}}> While you are browsing through the Site, the Site's operating system may automatically record some general information ("General Information") about your visit such as:
                  </span>
                  <ol className="list-roman ml-8 mt-3">
                    <li>
                      <span className="font-medium" style={{fontSize:"19px",color:"rgb(139, 102, 168)",fontWeight:"600"}}>i.</span>
                    ...
                    <li>
                      ...
                      The type of browser you are using (such as Internet Explorer version 7) or more
                    </li>
                    <li>
                      <span className="font-medium" style={{fontSize:"19px",color:"rgb(139, 102, 168)",fontWeight:"600"}}>iii.</span>
                      The type of OS you use like Mac or Window
                    </li>
                  </ol>
                </li>
                ...
                <li className="mt-6 font-medium">
                  <span className="font-medium" style={{fontSize:"20px",color:"rgb(139, 102, 168)",fontWeight:"600"}}>5.</span>
                  <span style={{fontWeight:"bold",fontSize:"17px",color:"#8B66A4",marginBottom:"15px"}}>COOKIES: </span>
                  <ol className="list-roman ml-8 mt-3">
                    <li>
                      <span className="font-medium" style={{fontSize:"19px",color:"rgb(139, 102, 168)",fontWeight:"600"}}>i.</span>
                      "Cookies" are small amounts of data that a website can send to a web browser on a visitor's computer. The cookie is stored on a 
                      visitor's computer. A cookie may enable the site holder to track how a visitor navigates through the site and the areas in which they 
                      show interest. This is similar to a traffic report: it tracks trends and behaviors, but does not identify individuals.
                    </li>
                    ...
                    <li className="mt-3 font-medium">
                      <span className="font-medium" style={{fontSize:"19px",color:"rgb(139, 102, 168)",fontWeight:"600"}}>iii.</span>
                      TYPES OF COOKIES:
                      <ol className="list-alpha ml-8 mt-3">
                        <li>
                          <span style={{fontSize:"17px"}}>a.</span> Cookies can be set to expire: on a specified date after a specific period of time when a transaction has been completed or
                          when a user turns off his/her browser.
                        </li>
                        
                        <li className="mt-3">
                          <span style={{fontSize:"17px"}}>b.</span> A cookie that is erased from memory when a visitor's browser closes is called a "session" cookie. Cookies that expire based
                          on a time set by the Web server are called "persistent" cookies.
                        </li>
                        
                        <li className="mt-3">
                          <span style={{fontSize:"17px"}}>c.</span> To browse anonymously, you may set your browser to disable cookies or delete cookies. Please note that disabling cookies
                          for some services will impact ability to use that service.
                        </li>
                      </ol>
                    </li>
                    ...
                    <li className="mt-3">
                      <span className="font-medium" style={{fontSize:"19px",color:"rgb(139, 102, 168)",fontWeight:"600"}}>v.</span>
                      Newer browser versions allow you to be notified or to automatically refuse cookies. You may need to download a more current
                      version of your web browser from your browser's website in order to obtain this option.
                    </li>
            ...
            <div className="col-xl-12 col-lg-9 col-md-11">
              ...
              <ol className="list-decimal ml-8 mt-4">
                ...
                <li className="mt-4" style={{fontWeight:"100",color:"rgb(33, 37, 41)",fontSize:"17px",lineHeight:"1.5",fontFamily:"Montserrat, sans-serif"}}>
                  ...
                  Maintaining an internal confidential database of all the Personal Information collected from visitors to the Site
                </li>
              ...
              <h2 className="font-medium mt-8" style={{fontSize:"25px",color:"rgb(139, 102, 168)",fontWeight:"600"}}>7. DISCLOSURE OF PERSONAL INFORMATION BY SMARTCLIFF</h2>
              ...
              <h2 className="font-medium mt-8" style={{fontSize:"25px",color:"rgb(139, 102, 168)",fontWeight:"600"}}>8. SECURITY</h2>

                  ...
                  .map((step, index) => (
                    <React.Fragment key={index}>
                      ...
                      <div className="col-xl-2 col-lg-3 col-md-6">
                        <div className="d-flex flex-column items-center text-center" style={{marginTop:"20px"}}>
                      ...
                      {index < 2 &&
                        rowIndex * 3 + index + 1 < processSteps.length && (
                          <div className="col-auto xl:d-none" >
                            <div className="pt-30" style={{marginTop:"40px"}}>
                              <Image
                                width={142}
                                height={21}
                                src={`/assets/img/misc/lines/${rowIndex * 3 + index + 1

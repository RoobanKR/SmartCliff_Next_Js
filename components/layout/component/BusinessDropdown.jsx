                        ...
                        >
                            <motion.div variants={itemVariants} whileHover="hover" initial="initial">
                                <Link
                                    ...
                                    className={`flex items-center justify-between px-4 py-2 text-sm hover:bg-white transition-colors duration-200 ${isActive("/corporate") ? "text-orange-1 font-medium" : ""
                                        }`}
                                >
                        ...
                        {menuList[4].links
                            ...
                            .map((item, idx) => (
                                ...
                                >
                                    <Link
                                        href={item.href}
                                        className={`block px-4 py-2 text-sm hover:bg-white transition-colors duration-200 ${isActive(item.href) ? "text-orange-1 font-medium" : ""
                                            }`}
                                    >

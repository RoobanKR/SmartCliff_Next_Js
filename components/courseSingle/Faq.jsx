                ...
                {item.faqItems.map((faqItem, j) => (
                  <div key={faqItem._id}>
                    <div
                      ...
                      className={`accordion__button py-20 mt-10 px-30 bg-light-4 ${activeItemId === faqItem._id ? "is-active" : ""
                        }`}
                    >
                    ...
                    <div
                      className={`accordion__content ${activeItemId === faqItem._id ? "is-active" : ""
                        }`}
                      style={
